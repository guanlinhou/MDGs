...
###barchat dataset 
data1.1 <- read.csv("data1.1.csv")
data1.2 <- read.csv("data1.2.csv")
data1.3 <- read.csv("data1.3.csv")
data2.1 <- read.csv("data2.1.csv")
data3.1 <- read.csv("data3.1.csv")
data4.1 <- read.csv("data4.1.csv")
data5.1 <- read.csv("data5.1.csv")
data5.2 <- read.csv("data5.2.csv")
data6.1 <- read.csv("data6.1.csv")
data6.2 <- read.csv("data6.2.csv")
data6.3 <- read.csv("data6.3.csv")
data7.1 <- read.csv("data7.1.csv")
data7.2 <- read.csv("data7.2.csv")
data7.3 <- read.csv("data7.3.csv")
data7.4 <- read.csv("data7.4.csv")
data8.1 <- read.csv("data8.1.csv")
data8.2 <- read.csv("data8.2.csv")
data8.3 <- read.csv("data8.3.csv")
data8.4 <- read.csv("data8.4.csv")
data8.5 <- read.csv("data8.5.csv")
###motionchart dataset 
goal1.1<- read.delim("goal1.1.txt")
goal1.2<- read.delim("goal1.2.txt")
goal1.3<- read.delim("goal1.3.txt")
goal2.1<- read.delim("goal2.1.txt")
goal3.1<- read.delim("goal3.1.txt")
goal4.1<- read.delim("goal4.1.txt")
goal5.1<- read.delim("goal5.1.txt")
goal5.2<- read.delim("goal5.2.txt")
goal6.1<- read.delim("goal6.1.txt")
goal6.2<- read.delim("goal6.2.txt")
goal6.3<- read.delim("goal6.3.txt")
goal7.1<- read.delim("goal7.1.txt")
goal7.2<- read.delim("goal7.2.txt")
goal7.3<- read.delim("goal7.3.txt")
goal7.4<- read.delim("goal7.4.txt")
goal8.1<- read.delim("goal8.1.txt")
goal8.2<- read.delim("goal8.2.txt")
goal8.3<- read.delim("goal8.3.txt")
goal8.4<- read.delim("goal8.4.txt")
goal8.5<- read.delim("goal8.5.txt")
